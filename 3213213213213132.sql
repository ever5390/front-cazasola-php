...
-- Volcando datos para la tabla drive_unac.archivo: ~19 rows (aproximadamente)
...
INSERT INTO `archivo` (`id`, `titulo`, `name_archivo`, `descripcion`, `tipo_archivo`, `id_detallecp`, `fecha_subida`, `fecha_entrega`) VALUES
	...
	(15, 'CJDBC-C-LaboratorioCapaDatosJDBC.pdf', 'CJDBC-C-LaboratorioCapaDatosJDBC.pdf', 'QL (Structured Query Language) es un lenguaje de programaciÃ³n diseÃ±ado para almacenar, manipular y recuperar datos almacenados en bases de datos relacionales. La primera encarnaciÃ³n de SQL apareciÃ³ en 1974, cuando un grupo de IBM desarrollÃ³ el primer prototipo de una base de datos relacional. Relational Software (luego se convirtiÃ³ en Oracle) lanzÃ³ la primera base de datos relacional comercial.\r\n\r\nExisten estÃ¡ndares para SQL. Sin embargo, el SQL que puede utilizarse en cada uno de las principales RDBMS actuales viene en distintas formas. Esto se debe a dos razones: 1) el estÃ¡ndar SQL es bastante complejo, y no es prÃ¡ctico implementar el estÃ¡ndar completo, y 2) cada proveedor de base de datos necesita una forma de diferenciar su producto de otros. En esta guÃ­a de referencia, dichas diferencia', 1, 2, '2018-11-28 07:55:06', '2018-11-30 00:00:00'),
	(16, 'CJDBC-A-LaboratorioFinalJDBC.pdf', 'CJDBC-A-LaboratorioFinalJDBC.pdf', 'QL (Structured Query Language) es un lenguaje de programaciÃ³n diseÃ±ado para almacenar, manipular y recuperar datos almacenados en bases de datos relacionales. La primera encarnaciÃ³n de SQL apareciÃ³ en 1974, cuando un grupo de IBM desarrollÃ³ el primer prototipo de una base de datos relacional. Relational Software (luego se convirtiÃ³ en Oracle) lanzÃ³ la primera base de datos relacional comercial.\r\n\r\nExisten estÃ¡ndares para SQL. Sin embargo, el SQL que puede utilizarse en cada uno de las principales RDBMS actuales viene en distintas formas. Esto se debe a dos razones: 1) el estÃ¡ndar SQL es bastante complejo, y no es prÃ¡ctico implementar el estÃ¡ndar completo, y 2) cada proveedor de base de datos necesita una forma de diferenciar su producto de otros. En esta guÃ­a de referencia, dichas diferencia', 2, 2, '2018-11-28 07:55:31', '2018-11-30 00:00:00'),
	(17, 'Imagen para fondo de AplicaciÃ³n', 'bg.jpg', '$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje$mensaje', 2, 2, '2018-11-28 08:04:15', '2018-11-30 00:00:00'),
	(18, 'Big Data Principles and Best Practices of Scalable Realtime Data Systems.pdf', 'Big Data Principles and Best Practices of Scalable Realtime Data Systems.pdf', 'QL (Structured Query Language) es un lenguaje de programaciÃ³n diseÃ±ado para almacenar, manipular y recuperar datos almacenados en bases de datos relacionales. La primera encarnaciÃ³n de SQL apareciÃ³ en 1974, cuando un grupo de IBM desarrollÃ³ el primer prototipo de una base de datos relacional. Relational Software (luego se convirtiÃ³ en Oracle) lanzÃ³ la primera base de datos relacional comercial.\r\n\r\nExisten estÃ¡ndares para SQL. Sin embargo, el SQL que puede utilizarse en cada uno de las principales RDBMS actuales viene en distintas formas. Esto se debe a dos razones: 1) el estÃ¡ndar SQL es bastante complejo, y no es prÃ¡ctico implementar el estÃ¡ndar completo, y 2) cada proveedor de base de datos necesita una forma de diferenciar su producto de otros. En esta guÃ­a de referencia, dichas diferencia', 2, 3, '2018-11-28 08:08:41', '2018-11-30 00:00:00'),
	(19, 'Getting_Started_With_Apache_Spark.pdf', 'Getting_Started_With_Apache_Spark.pdf', 'Como resultado, solo es posible seleccionar los dÃ­as del mes de abril de 2017; solo la parte de los dÃ­as del valor de texto es modificable, y no se puede desplazar a ninguna fecha que caiga fuera de abril en la interfaz de selecciÃ³n de fechas.\r\n\r\nNota: deberÃ­a ser capaz de utilizar el atributo step para variar el nÃºmero de dÃ­as que se recorren con cada incremento de fecha (p. ej., puede que desee que solo se puedan seleccionar los sÃ¡bados). No obstante, esto no parece funcionar en ninguna implementaciÃ³n en el momento en que se redactÃ³ esta pÃ¡gina.Como resultado, solo es posible seleccionar los dÃ­as del mes de abril de 2017; solo la parte de los dÃ­as del valor de texto es modificable, y no se puede desplazar a ninguna fecha que caiga fuera de abril en la interfaz de selecciÃ³n de fechas.\r\n\r\nNota', 2, 3, '2018-11-28 08:14:22', '2018-11-13 00:00:00'),
	(20, 'I Heart Logs Event Data, Stream Processing, and Data Integration.pdf', 'I Heart Logs Event Data, Stream Processing, and Data Integration.pdf', 'Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la f', 2, 3, '2018-11-28 08:21:42', '2018-11-30 00:00:00'),
	(21, 'DiseÃ±o de una arquitectura para Big Data.pdf', 'DiseÃ±o de una arquitectura para Big Data.pdf', 'Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la f', 2, 3, '2018-11-28 08:22:17', '2018-12-28 00:00:00'),
	(22, 'Big-Data-Data-Science(casos uso).pdf', 'Big-Data-Data-Science(casos uso).pdf', 'Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la f', 2, 3, '2018-11-28 08:23:13', '2018-11-30 00:00:00'),
	(23, 'Recommender Systems Handbook.pdf', 'Recommender Systems Handbook.pdf', 'Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:Puede utilizar los atributos min y max para restringir las fechas que el usuario puede seleccionar. En el ejemplo siguiente, definiremos como la fecha mÃ­nima 2017-04-01 y 2017-04-30 como la fecha mÃ¡xima:', 2, 3, '2018-11-28 08:23:38', '2018-12-21 00:00:00');
...
-- Volcando datos para la tabla drive_unac.descargas_archivos_alumnos: ~6 rows (aproximadamente)
...
INSERT INTO `descargas_archivos_alumnos` (`id_descarga`, `id_archivo`, `id_usuario`, `id_detallecp`, `fecha_descarga`) VALUES
	...
	(8, 14, 3, 3, '2018-11-28 14:32:57'),
	(9, 3, 9, 1, '2018-11-28 23:27:51'),
	(10, 10, 9, 1, '2018-11-28 23:27:55'),
	(11, 15, 9, 2, '2018-11-28 23:28:14'),
	(12, 17, 9, 2, '2018-11-28 23:28:16'),
	(13, 16, 9, 2, '2018-11-28 23:28:18'),
	(14, 14, 9, 3, '2018-11-28 23:28:33'),
	(15, 22, 9, 3, '2018-11-28 23:28:36');
...
INSERT INTO `usuario` (`id_usuario`, `usuario`, `contrasena`, `nivel`, `nombres`, `dni`, `correo`, `telefono`, `imagen`) VALUES
	(1, 'pedro', '12345', 1, 'Pedro Pablo Peralta Perez', 12345678, 'pedro.ppp@gmail.com', 258963147, 'pedro.jpg'),
